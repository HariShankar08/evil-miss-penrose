...
# save cosine values
with open(destination_folder+"cosines_novel_spr_llama"+"_layer_"+str(LAYER)+".csv",'w') as f:
    write = csv.writer(f)
...
df2.to_csv(destination_folder+"embeddings_novel_spr_llama"+"_layer_"+str(LAYER)+".csv", index = False)
