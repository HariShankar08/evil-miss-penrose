...
destination_folder = '../CWE_output/spr_existing/layer_'+str(LAYER)+'/'
os.makedirs(destination_folder, exist_ok=True)

# save cosine values
with open(destination_folder+'cosines_existing_spr.csv','w') as f:
    write = csv.writer(f)
...
df2.to_csv(destination_folder+"embeddings_existing_spr.csv", index = False)
